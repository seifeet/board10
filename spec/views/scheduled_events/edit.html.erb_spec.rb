...
describe "scheduled_events/edit.html.erb" do
  before(:each) do
    @scheduled_event = assign(:scheduled_event, stub_model(ScheduledEvent,
      :repeat => 1,
      :mo => false,
      :tu => false,
      :we => false,
  ...
  it "renders the edit scheduled_event form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => scheduled_events_path(@scheduled_event), :method => "post" do
